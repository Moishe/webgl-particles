...
function setup1() {
  ...
  for (var i = 0; i < numLines; i++) {
    ...
    var rad = i / numLines * 2 + .5; // Math.random() * 2 + .5;
    var theta = i / numLines * Math.PI * 2; // Math.random() * Math.PI * 2;
    var velTheta = 0; // Math.random() * Math.PI * 2;
